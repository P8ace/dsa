from src.nonpolynomial.travellingsalesman import tsp, verify_tsp
...
def test_travelling_salesman():
    ...
    for test_case in submit_cases:
        result = tsp(test_case[0], test_case[1], test_case[2])
...
def test_verify_tsp():
    ...
    for test_case in submit_cases:
        result = verify_tsp(test_case[0],test_case[1],test_case[2])
